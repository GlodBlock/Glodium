...
public class NBTRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public NBTRecipeBuilder(RecipeCategory p_249996_, ItemStack p_251475_) {
        this.category = p_249996_;
        this.result = p_251475_;
    }

    public static NBTRecipeBuilder shaped(RecipeCategory p_250853_, ItemLike p_249747_) {
        return shaped(p_250853_, p_249747_, 1);
    }

    public static NBTRecipeBuilder shaped(RecipeCategory p_251325_, ItemLike p_250636_, int p_249081_) {
        return shaped(p_251325_, new ItemStack(p_250636_, p_249081_));
    }

    public static NBTRecipeBuilder shaped(RecipeCategory p_251325_, ItemStack p_251475_) {
    ...
    public void save(Consumer<FinishedRecipe> p_126141_, @NotNull ResourceLocation p_126142_) {
        ...
        p_126141_.accept(new NBTRecipeBuilder.Result(p_126142_, this.result, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, p_126142_.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.showNotification));
    }
    ...
    public static class Result extends CraftingRecipeBuilder.CraftingResult {
        ...
        public Result(ResourceLocation p_273548_, ItemStack p_273530_, String p_273549_, CraftingBookCategory p_273500_, List<String> p_273744_, Map<Character, Ingredient> p_272991_, Advancement.Builder p_273260_, ResourceLocation p_273106_, boolean p_272862_) {
            super(p_273500_);
            this.id = p_273548_;
